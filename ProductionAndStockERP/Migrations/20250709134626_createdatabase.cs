    ...
    public partial class createdatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductionOrders", x => x.ProductionId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    StockTxnId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StockTransactions", x => x.StockTxnId);
                    table.ForeignKey(
                        name: "FK_StockTransactions_Orders_RelatedOrderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockTransactions_RelatedOrderId",
